...
#### Note: This web app was built for a university project and it supports only 2 languages(<span style="color: red;">english</span> & <span style="color: blue;">greek</span>).
